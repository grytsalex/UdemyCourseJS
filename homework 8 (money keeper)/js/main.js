...
expensesBtn.addEventListener('click', function() { // при клике запускаеться функция
    let sum = 0; // переменная суммы собирает все ценники что ввел ползователь

    for (let i = 0; i < expensesItem.length; i++) { // цикл работает до момента окончания 'imput' на странице
